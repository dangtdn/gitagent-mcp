...
export function registerLabelTools(server) {
    ...
    server.registerTool("add_labels", {
        title: "Add Labels",
        ...
        try {
            ...
            return formatTextContent(`✅ Labels added to #${issue_number}: ${addedLabels.join(", ")}`);
        }
        catch (error) {
    ...
    server.registerTool("remove_labels", {
        title: "Remove Labels",
        ...
        try {
            ...
            return formatTextContent(`✅ Label "${name}" removed from #${issue_number}`);
        }
        catch (error) {
            return formatError(error);
        }
